...
pub struct AppConfig {
    ...
    pub remote_role_run: bool,
    pub remote_role_desktop: bool,
    ...
    pub remote_default_role_run: bool,
    pub remote_default_role_desktop: bool,
...
struct PersistedConfig {
    ...
    #[serde(default = "default_true")]
    remote_role_run: bool,
    #[serde(default = "default_true")]
    remote_role_desktop: bool,
    #[serde(default = "default_true")]
    ...
    #[serde(default)]
    remote_default_role_run: bool,
    #[serde(default)]
    remote_default_role_desktop: bool,
...
impl Default for PersistedConfig {
    fn default() -> Self {
        Self {
            ...
            remote_role_run: true,
            remote_role_desktop: true,
            ...
            remote_default_role_run: false,
            remote_default_role_desktop: false,
...
impl AppConfig {
    pub fn load() -> Self {
        ...
        Self {
            ...
            remote_role_run: persisted.remote_role_run,
            remote_role_desktop: persisted.remote_role_desktop,
            ...
            remote_default_role_run: persisted.remote_default_role_run,
            remote_default_role_desktop: persisted.remote_default_role_desktop,
    ...
    pub fn save(&self) -> anyhow::Result<()> {
        ...
        let persisted = PersistedConfig {
            ...
            remote_role_run: self.remote_role_run,
            remote_role_desktop: self.remote_role_desktop,
            ...
            remote_default_role_run: self.remote_default_role_run,
            remote_default_role_desktop: self.remote_default_role_desktop,
            remote_default_device_ttl_days: normalize_remote_device_ttl_days(
